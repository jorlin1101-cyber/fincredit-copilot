...
export function CameraCapture({ onCapture, disabled }: CameraCaptureProps) {
  ...
  const buttonClass = cn(
    'inline-flex w-full items-center justify-center gap-2 rounded-lg border border-border px-4 py-2.5 text-sm font-medium text-muted-foreground transition-colors hover:border-primary/30 hover:bg-secondary hover:text-foreground dark:border-border dark:hover:border-slate-600 dark:hover:bg-muted',
            ...
            {state === 'captured' && (
              <>
                ...
                <button
                  ...
                  className="flex items-center gap-2 rounded-lg bg-card px-4 py-2.5 text-sm font-medium text-black transition-colors hover:bg-white/90"
                >
