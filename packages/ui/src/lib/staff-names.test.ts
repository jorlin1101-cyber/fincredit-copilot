...
describe('staffName', () => {
  it('should return the display name for a known CEO UUID', () => {
    expect(staffName('d1a2b3c4-e5f6-7890-abcd-ef1234567801')).toBe('李晓雨');
  });

  it('should return the display name for a known underwriter UUID', () => {
    expect(staffName('d1a2b3c4-e5f6-7890-abcd-ef1234567803')).toBe('陈静');
  });

  it('should return the display name for a known loan officer UUID', () => {
    expect(staffName('d1a2b3c4-e5f6-7890-abcd-ef1234567802')).toBe('王晨');
  });
