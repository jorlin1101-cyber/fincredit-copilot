...
describe('formatExtractionValue', () => {
  it('translates legacy organizations and account values', () => {
    expect(
      formatExtractionValue('employer_name', 'US Department of Veterans Affairs'),
    ).toBe('成都优抚服务中心（演示）');
  ...
  it('formats legacy currency and dates for the Chinese demo', () => {
    ...
    expect(formatExtractionValue('expiration_date', '2027-11-30')).toBe(
      '2027年11月30日',
    );
