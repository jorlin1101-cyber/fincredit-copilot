...
### Optional external safety service

The chart does not bundle a vendor-specific safety model or proxy image.
If an independently operated compatible safety endpoint is available, set
`secrets.NEMO_GUARDRAILS_ENDPOINT`; otherwise leave it empty.
